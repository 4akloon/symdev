//! What the manifest accepts and what it refuses. The crate is named through
//! `symdev_manifest::` here so the assertions read as an outside caller's do.
extern crate self as symdev_manifest;

use super::*;
pub(crate) const HELLO: &str = r#"
[package]
name = "hello"
version = "0.1.0"
