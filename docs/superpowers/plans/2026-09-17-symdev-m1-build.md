...
- Commit after each task with `GIT_AUTHOR_NAME="Yevhenii Aleksiuk"` `GIT_AUTHOR_EMAIL="38440891+4akloon@users.noreply.github.com"` (and matching `GIT_COMMITTER_*`). Do not write git config.
